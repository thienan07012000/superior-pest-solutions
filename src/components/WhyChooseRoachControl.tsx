...
const benefits = [
  {
    title: "We Know NWA",
    description: "We've been here a long time. We know which roaches show up, when they show up, and exactly where they hide.",
    icon: <MapPin className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Works Fast",
    description: "You'll notice a difference quickly. No waiting weeks to see if it's working.",
    icon: <Zap className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "Safe for Kids & Pets",
    description: "We get rid of roaches without putting your family or animals at risk.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "We Cover the Whole House",
    description: "Kitchens, cabinets, appliances, wall gaps. Everywhere roaches go, we go.",
    icon: <Home className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "No Contracts",
    description: "No long-term commitments. You call when you need us, and that's it.",
    icon: <CalendarCheck className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseRoachControl = () => {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight">
            ...
            <span className="text-[var(--brand-red)] inline-block mt-2">We Actually Work</span>
          </h2>
        </motion.div>
