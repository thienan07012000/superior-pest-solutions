...
import { MapPin, ShieldCheck, Target, CalendarCheck, Leaf } from 'lucide-react';

const benefits = [
  {
    title: "We Know NWA Fleas",
    description: "We know which fleas are common in Northwest Arkansas, when they're most active, and exactly how to deal with them.",
    icon: <MapPin className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Safe for Family & Pets",
    description: "Our treatments are tough on fleas but gentle on your family and animals. No harsh chemicals you need to worry about.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "We Go Where Fleas Hide",
    description: "Carpets, furniture cushions, pet bedding. We treat the spots fleas actually live, not just the ones you can see.",
    icon: <Target className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "We Follow Up",
    description: "Fleas can be stubborn. That's why we come back to check and re-treat if needed, so they don't return.",
    icon: <CalendarCheck className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "Eco-Friendly Options",
    description: "Strong control with minimal impact on the environment. We care about what goes into your home.",
    icon: <Leaf className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseFleaControl = () => {
  return (
