...
import { Zap, ShieldCheck, Search, BadgeDollarSign, CalendarCheck } from 'lucide-react';

const benefits = [
  {
    title: "Fast and Reliable",
    description: "We show up quickly and get the job done right the first time. No dragging it out, no guessing.",
    icon: <Zap className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Safe for Your Family",
    description: "Our treatments are safe for kids, pets, and everyone in your household. You don't have to worry.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "Full Inspection Included",
    description: "We check every corner, crack, and damp area in your home. Then we target exactly where the silverfish are hiding.",
    icon: <Search className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "Results That Last",
    description: "We don't just kill the ones you see. We treat the problem at the source so silverfish stay gone for good.",
    icon: <CalendarCheck className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "Affordable and Honest",
    description: "No surprises, no hidden fees. We tell you what it costs up front and stick to it.",
    icon: <BadgeDollarSign className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseSilverfishControl = () => {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight">
            ...
            <span className="text-[var(--brand-red)] inline-block mt-2">We Get It Done</span>
          </h2>
        </motion.div>
