...
import { Zap, ShieldCheck, Search, Lock, Leaf } from 'lucide-react';

const benefits = [
  {
    title: "Fast Removal",
    description: "We quickly get rid of active rodent problems using targeted, professional methods. You'll see results fast, not weeks from now.",
    icon: <Zap className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Safe for Your Family",
    description: "Our treatments protect your family, pets, and home. Everything we use is safe and approved for residential use.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "Licensed & Trained",
    description: "Our technicians know how to find entry points, nesting areas, and the routes rodents use to move through your home.",
    icon: <Search className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "We Seal Entry Points",
    description: "We don't just remove rodents. We seal up the gaps and holes they used to get in so they can't come back.",
    icon: <Lock className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "Eco-Friendly Options",
    description: "We offer humane and environmentally responsible rodent control. You get results without harming the environment.",
    icon: <Leaf className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseRodentControl = () => {
  return (
