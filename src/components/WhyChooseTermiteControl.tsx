...
import { BadgeCheck, Sliders, Leaf, ShieldCheck, Zap } from 'lucide-react';

const benefits = [
  {
    title: "Licensed & Certified",
    description: "Our technicians are licensed and have treated termite problems in NWA homes for years. They know what to look for and how to fix it.",
    icon: <BadgeCheck className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Treated for Your Home",
    description: "Every home is different. We look at your specific situation before deciding on a treatment, so you're not getting a generic plan that may not actually fit.",
    icon: <Sliders className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "Safe for Kids and Pets",
    description: "Our treatments are strong enough to wipe out a colony, but safe for your kids and pets once they're applied and dry.",
    icon: <Leaf className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "Guaranteed Results",
    description: "If termites show back up after we treat your home, we come back and take care of it. No extra charge, no hassle.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "Fast Response",
    description: "We're local, so we can get to you fast. No waiting weeks for a national company to fit you into their schedule.",
    icon: <Zap className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseTermiteControl = () => {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight">
            Why Hire a <br className="hidden md:block" />
            <span className="text-[var(--brand-red)] inline-block mt-2">Local Exterminator?</span>
          </h2>
        </motion.div>
