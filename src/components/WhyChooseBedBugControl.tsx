...
import { MapPin, ShieldCheck, Target, RefreshCw, Leaf } from 'lucide-react';

const benefits = [
  {
    title: "Local Experts",
    description: "We know NWA bed bug behavior and patterns. We've handled hundreds of infestations in this area and know exactly what to look for.",
    icon: <MapPin className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Safe Treatments",
    description: "Our bed bug control methods are family- and pet-friendly. You don't have to choose between getting rid of bugs and keeping your home safe.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "Targeted Approach",
    description: "We focus on the hiding spots that matter: bedding, furniture seams, crevices, and baseboards. We go where they go.",
    icon: <Target className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "Long-Term Results",
    description: "Follow-ups and inspections after treatment make sure they don't come back. We stay on it until your home is clear.",
    icon: <RefreshCw className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "Eco-Friendly Options",
    description: "We offer treatments that are effective against bed bugs with the smallest environmental footprint possible.",
    icon: <Leaf className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseBedBugControl = () => {
  return (
