...
const benefits = [
  {
    title: "We Know NWA Spiders",
    description: "We have been out here a long time. We know which spiders show up around Northwest Arkansas, where they like to hide, and the best way to get rid of them.",
    icon: <MapPin className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Works Fast",
    description: "You will notice a difference quickly. We go after the nests and the entry points so you get real relief, not just a temporary fix.",
    icon: <Zap className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "Safe for Kids & Pets",
    description: "We get rid of spiders without putting your family or animals at risk. Everything we use is safe for your home.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "We Get the Nests, Not Just the Ones You See",
    description: "Killing the spider on your wall does not fix the problem. We find the nests, the egg sacs, and the entry points so they actually stop coming back.",
    icon: <Home className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "No Contracts",
    description: "We can set up follow-up visits to keep your home spider-free, but you are never locked into anything. You call when you need us, and that is it.",
    icon: <CalendarCheck className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseSpiderControl = () => {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight">
            ...
            <span className="text-[var(--brand-red)] inline-block mt-2">We Actually Get Rid of Them</span>
          </h2>
        </motion.div>
