...
const benefits = [
  {
    title: "We Know NWA",
    description: "We have been here a long time. We know which wasps show up around here and exactly how to handle their nests safely.",
    icon: <MapPin className="w-6 h-6" />,
    number: "01",
  },
  {
    title: "Safe Nest Removal",
    description: "We remove wasp nests without putting your family or pets at risk. Our technicians use the right gear and the right products to get the job done safely.",
    icon: <Zap className="w-6 h-6" />,
    number: "02",
  },
  {
    title: "Safe for Kids & Pets",
    description: "The treatments we use target the wasps, not your family. Once applied, they are gentle and safe for everyone in your home.",
    icon: <ShieldCheck className="w-6 h-6" />,
    number: "03",
  },
  {
    title: "We Eliminate the Whole Nest",
    description: "Killing a few wasps does not solve the problem. We locate every nest on your property, treat it, and remove it so the colony does not rebuild.",
    icon: <Home className="w-6 h-6" />,
    number: "04",
  },
  {
    title: "No Contracts",
    description: "No long-term commitments. You call when you need us, and that is it. We can set up a prevention plan, but it is always your choice.",
    icon: <CalendarCheck className="w-6 h-6" />,
    number: "05",
  }
];

export const WhyChooseWaspControl = () => {
  return (
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-tight">
            ...
            <span className="text-[var(--brand-red)] inline-block mt-2">We Get Rid of the Whole Nest</span>
          </h2>
        </motion.div>
